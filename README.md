...
| [`@NumberLessThan(threshold: number, error?: ValidationError)`](https://github.com/gabsschrodinger/class-handler/blob/main/docs/NumberLessThan.md)            | not being a number or being a number greater or equal than a given threshold (first parameter)       |
| [`@StringMatchingRegex(regex: RegExp, error?: ValidationError)`](https://github.com/gabsschrodinger/class-handler/blob/main/docs/StringMatchingRegex.md)      | not being a string or don't matching the given regex (first parameter)                               |
| [`@NumericString(error?: ValidationError)`](https://github.com/gabsschrodinger/class-handler/blob/main/docs/NumericString.md)                                 | not being a string or being a string with non-numeric chars                                          |
| [`@AlphanumericString(error?: ValidationError)`](https://github.com/gabsschrodinger/class-handler/blob/main/docs/AlphanumericString.md)                       | not being a string or being a string with non-alphanumeric chars                                     |
